         ...
         <> 
            ...
            { displayWelcomeMessage ? 
               <div className="explanation-and-welcome">
                  ...
                  PLEASE NOTE: Unfortunately the JavaScript geolocation methods have been deprecated for http sites. This means paying for a SSL certificate (circa £200+ per year) which is not currently an option. This has now been rolled out to all browsers. Please use the search field instead. More information can be found at: <br/>https://developers.google.com/web/updates/2016/04/geolocation-on-secure-contexts-only. If you are interested in how the code for this method works please visit this component's code on GitHub at: <br/>https://github.com/ck2e14/frontend5/blob/master/src/components/home/Home.js. Additionally you may download the repo and run it locally - browsers treat localhost as secure.
